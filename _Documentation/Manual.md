...
####Pre version 6 to version 6 upgrades
...
5.	Add a title for your blog. Under “Permissions” select the checkbox “All Users/View Comments” and “All Users/Add Comment”. Click “Update”. Click “Return” to return to the main page.
...
![Admin screen](images/2013-07-23_11-37-08.png)
...
![Localization](images/2013-07-23_17-44-31.png)
 
###Allow All Languages
Bloggers can now indicate for each post in their blog what language the post is in. This allows us to filter at a later stage if desired. This option allows users to indicate any language for their post. The default is not selected, which means that only one of the portal languages is allowed.

###Edit Tag Localization
This button takes you to an editor where you can specify translations for the tags used in various posts for this module.
...
![Categories init](images/2013-07-25_10-26-41.png)
...
![Module Settings](images/2013-07-23_18-07-21.png)
...
![Adding a blog](images/2013-07-24_08-52-55.png)

###Title/Description
The title is compulsory. The description is not. The latter
...
![Blog settings 3](images/2013-07-24_09-06-50.png)
...
###Must Approve Ghostwritten Posts
...
![Post edit summary](images/2013-07-24_10-39-31.png)
...
![Post edit details](images/2013-07-24_10-45-18.png)
...
    [subtemplate|Post.html|Posts|pagesize=10]This would render posts paged to 10 posts. A list of collections and their options are included in this document.####Location and Organization of TemplatesTemplates are found either in the module’s own directory (DesktopModules/Blog/Templates) or in a portal’s directory (Portals/[id]/Blog/Templates). A template is contained in a single subdirectory of one of these directories:
