...
<asp:DataList ID="lstArchiveMonths" runat="server" Width="100%" CssClass="CommandButton" CellPadding="0" CellSpacing="0" BorderWidth="0">
 <ItemTemplate>
  <table width="100%" cellpadding="0" cellspacing="0" border="0" align="left">
   <tr>
    ...
    <td align="right">
     <asp:HyperLink ImageUrl="~/desktopmodules/Blog/Images/feed-icon-12x12.gif" CssClass="CommandButton" runat="server" ID="lnkBlogRSS" Visible="False" Target="_blank" />
    </td>
   </tr>
  </table>
 </ItemTemplate>
