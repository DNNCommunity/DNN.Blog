...
<div class="blog_body">
    ...
    <p class="blog_subhead">
        ...
        <asp:HyperLink ID="lnkRss" runat="server" ImageUrl="~/desktopmodules/Blog/Images/feed-icon-12x12.gif"
            Target="_blank" resourcekey="lnkRss" />
    </p>
    <!-- End Blog Sub Head -->
    ...
    <div class="blog_footer">
            <span class="blog_topics">
                ...
                <asp:Repeater ID="rptTags" runat="server">
                    <ItemTemplate>
                        <asp:HyperLink runat="server" ID="lnkTags" Text='<%# Eval("Tag") %>' NavigateUrl='<%# DotNetNuke.Common.NavigateURL(TabId, "", "tagid=" & Eval("TagID")) %>'>HyperLink</asp:HyperLink></ItemTemplate>
                    <SeparatorTemplate>
                        ,
                    </SeparatorTemplate>
                </asp:Repeater>
            ...
            <span class="blog_topics">
                ...
                <asp:Repeater ID="rptCategories" runat="server">
                    <ItemTemplate>
                        <asp:HyperLink runat="server" ID="lnkCategories" Text='<%# Eval("Category") %>' NavigateUrl='<%# DotNetNuke.Common.NavigateURL(TabId, "", "catid=" & Eval("CatID")) %>'>HyperLink</asp:HyperLink></ItemTemplate>
                    <SeparatorTemplate>
                        ,
                    </SeparatorTemplate>
                </asp:Repeater>
            ...
            <asp:HyperLink ID="lnkTrackBack" ResourceKey="lnkTrackBack" CssClass="blog_trackback"
                runat="server" />
            <asp:LinkButton ID="cmdPrint" runat="server" CausesValidation="False" CssClass="blog_print"
                resourcekey="cmdPrint" />
            <asp:HyperLink ID="lnkEditEntry" ResourceKey="msgEditEntry" CssClass="blog_edit_link"
                runat="server" />
        </div>
    </div>
    ...
    <asp:Panel ID="pnlComments" runat="server" Visible="False">
        ...
        <asp:ImageButton ID="lnkDeleteAllUnapproved" runat="server" ImageUrl="~/images/delete.gif"
            Visible="false" ImageAlign="AbsMiddle" CausesValidation="false" />
                    ...
                    <blockquote>
                        ...
                        <p>
                            <asp:ImageButton ID="lnkEditComment" runat="server" Visible="false" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CommentID") %>'
                                CommandName="EditComment" ImageUrl="~/images/edit.gif" ImageAlign="AbsMiddle">
                            </asp:ImageButton>
    ...
    <asp:Panel ID="pnlAddComment" runat="server">
        ...
        <asp:RequiredFieldValidator ID="valCommentTitle" runat="server" ResourceKey="valCommentTitle.ErrorMessage"
            CssClass="NormalRed" Enabled="False" ErrorMessage="Title is required" ControlToValidate="txtCommentTitle"
            Display="None" EnableClientScript="False" />
        ...
        <table cellspacing="1" cellpadding="1" width="100%" border="0">
            ...
            <tr id="trUseGravatar" runat="server">
                ...
                <td>
                    <asp:Label ID="lblEmailExplanation" runat="server" ResourceKey="lblEmailExplanation"
                        CssClass="Normal">(Optional) Used only to display <a href="http://www.gravatar.com">
            ...
            <tr id="trCommentWebsite" runat="server">
                <td class="blog_lefttd" width="1%">
                    <asp:Label ID="lblWebsite" runat="server" ResourceKey="lblWebsite" CssClass="NormalBold"
                        Width="80px" />
                </td>
                <td colspan="2">
            ...
            <tr>
                <td colspan="3">
                    <asp:LinkButton ID="cmdAddComment" TabIndex="7" runat="server" CssClass="CommandButton"
                        BorderStyle="None" />&nbsp;&nbsp;
