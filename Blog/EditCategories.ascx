...
<table style="width: 100%;">
 <tr>
  <td>
   ...
   <br />
   <br />
   <asp:LinkButton ID="btnAddEdit" runat="server" />
   &nbsp;<asp:LinkButton ID="btnDelete" runat="server" ResourceKey="btnDelete" />
   &nbsp;<asp:LinkButton ID="btnCancel" runat="server" ResourceKey="btnCancel" />
  </td>
  <td valign="top">
