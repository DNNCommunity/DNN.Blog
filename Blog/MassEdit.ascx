...
<asp:Repeater ID="rptEdit" runat="server">
    <HeaderTemplate>
    <table><tr><th width="35%">Title</th><th width="25%">Category</th><th width="25%">Tags</th><th>Pub</th><th>Cmts</th></tr>
    </HeaderTemplate>
    <ItemTemplate>
    <tr>
    <td>
    ...
    <td>
        <asp:LinkButton ID="btnEditCmd" Visible="true" CommandName="Edit" runat="server">Edit</asp:LinkButton>
        ...
        <asp:LinkButton ID="btnCancelCmd" Visible="false" CommandName="Cancel" runat="server">Cancel</asp:LinkButton>
    </td>
    </tr>
    </ItemTemplate>
    <FooterTemplate>
...
<dnn:PagingControl id="Pagecontrol" runat="server"></dnn:PagingControl>  
