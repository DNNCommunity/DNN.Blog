  ...
  <asp:Table ID="tblHeader" CellPadding="0" CellSpacing="0" BorderWidth="0" runat="server">
   <asp:TableRow runat="server" ID="trHeader">
    <asp:TableCell runat="server" ID="tdHeaderIcon" Width="10">
     <asp:HyperLink runat="server" ImageUrl="~/desktopmodules/Blog/Images/folder_item.gif" ID="lnkBlogIcon" Font-Bold="True" />
    </asp:TableCell>
  ...
  <asp:Table ID="tblBlogList" runat="server" BorderWidth="0" CellSpacing="0" CellPadding="0">
   <asp:TableRow runat="server" ID="trBlogList">
    <asp:TableCell runat="server" ID="tdIcon" Width="10">
     <asp:HyperLink runat="server" ImageUrl="~/desktopmodules/Blog/Images/tree_item.gif" ID="lnkBlogIcon" />
    </asp:TableCell>
    ...
    <asp:TableCell runat="server" ID="tdBlogRSS" HorizontalAlign="Right">
     <asp:HyperLink ImageUrl="~/desktopmodules/Blog/Images/feed-icon-12x12.gif" runat="server" ID="lnkBlogRSS" Visible="False" Target="_blank" />
    </asp:TableCell>
   </asp:TableRow>
   <asp:TableRow runat="server" ID="trBlogChildren" Visible="False">
    <asp:TableCell runat="server" ID="Tablecell2" Width="10">
     <asp:Image ImageUrl="~/images/spacer.gif" runat="server" Width="8" Height="8" ID="Image1" Text=" " />
    </asp:TableCell>
       ...
       <asp:Table ID="tblChildBlogs" runat="server" BorderWidth="0" CellSpacing="0" CellPadding="0">
        <asp:TableRow runat="server" ID="trChildBlogs">
         <asp:TableCell runat="server" ID="tdChildIcon" Width="10">
          <asp:HyperLink runat="server" ImageUrl="~/desktopmodules/Blog/Images/tree_item.gif" ID="lnkChildIcon" />
         </asp:TableCell>
         ...
         <asp:TableCell runat="server" ID="tdChildBlogRSS" HorizontalAlign="Right">
          <asp:HyperLink ImageUrl="~/desktopmodules/Blog/Images/feed-icon-12x12.gif" runat="server" ID="lnkChildBlogRSS" Visible="False" Target="_blank" />
         </asp:TableCell>
        </asp:TableRow>
       </asp:Table>
      </ItemTemplate>
